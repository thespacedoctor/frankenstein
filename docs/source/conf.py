...
html_theme_options = {
    ...
    'github_repo': 'frankenstein',
    'strap_line': "Project Templates Brought to Life"
}
...
exclude_patterns = ['_build', '_templates',
                    '**__version__.py', '**setup.py', 'api/frankenstein.rst']
modindex_common_prefix = ["frankenstein."]

# (source start file, target name, title, author, documentclass [howto/manual]).
latex_documents = [
    ('index', 'frankenstein.tex', u'frankenstein Documentation',
     u'Dave Young', 'manual'),
]
...
def generateAutosummaryIndex():
    ...
    # GET ALL SUBPACKAGES
    allSubpackages = ["frankenstein"]
    allSubpackages += findAllSubpackges(
        pathToPackage="frankenstein"
    )
